...
public class Subject2_1 {
    ...
    private FlashCardMultipleChoice question1;
    private FlashCardMultipleChoice question2;
    private FlashCardMultipleChoice question3;
    private FlashCardMultipleChoice question4;
    private FlashCardMultipleChoice question5;
    private FlashCardMultipleChoice question6;
    private FlashCardMultipleChoice question7;
    ...
    void build2_1(){
        ...
        question1 = new FlashCardMultipleChoice(
    ...
    void build2_2(){
        ...
        question2 = new FlashCardMultipleChoice(
    ...
    void build2_3(){
        ...
        question3 = new FlashCardMultipleChoice(
    ...
    void build2_4(){
        ...
        injectAnswer(1,0,1,1);
        question4 = new FlashCardMultipleChoice(
    ...
    void build2_5(){
        ...
        question5 = new FlashCardMultipleChoice(
    ...
    void build2_6(){
        ...
        injectAnswer(0,0,1,0);
        question6 = new FlashCardMultipleChoice(
    ...
    void build2_7(){
        injectChoices("Represents important details while ignoring irrelevant details.",
                ...
                "Recognize similarities between two different problems and experiences.");
        injectAnswer(0,0,1,0);
        question7 = new FlashCardMultipleChoice(
